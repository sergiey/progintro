...
var
    ...
    isSucceed: boolean;
begin
    errMessage := 'Incorrect number of params: should be 3 (real, real, int)';
    {$I-}
    if ParamCount <> 3 then begin
        writeln(ErrOutput, errMessage);
        halt(1)
    end;
    x := StrToReal(ParamStr(1), isSucceed);
    y := StrToReal(ParamStr(2), isSucceed);
    n := StrToInteger(ParamStr(3), isSucceed);
    writeln((x * y):n:n)
end.